...
- **行星真实太阳**：3D 星球的昼夜随真实时间转动——正午照亮面向你的一侧，午夜夜半球靠冷色月光，晨昏线偏暖（跟随当前显示时区）；太阳高度随季节真值摆动
- **真实月相**：一颗按 29.53 天朔望周期绕行的小月亮，明暗面由真实太阳方向照出；夜光强弱随月相盈亏——满月夜明亮、新月夜沉暗
- **一日进度环 + 年度进度环**：3D 外圈两圈极淡细环分别按 24 小时与真实日历填满（闰年感知）——秒环是一分钟的形状，日环是一天的形状，年环是一年的形状
- **整点深呼吸**：每个真实整点星球一次极缓深脉冲（纯视觉无声音），布防期间自动让位给倒计时仪式
- **到点音景昼夜四态**：归零琶音按节点时刻自动换五声音阶——晨 C 大 / 昼 G 大 / 暮 E 小 / 夜 D 小，sub 冲击与钟簇余韵不变
- **音效主题包**：硅晶/钟琴/木质/芯片四套合成音色，下拉即换
- **每日击拍统计 + 黄金时段**：今日击拍/最高连击/准确率 + 近 30 天你最准的小时
- **到点历史统计**：今日到点/累计次数，累计每满 100 补一颗流星
- **闲置自流动**：10 分钟无操作界面退场、相机极缓自转、渲染降帧——你不在时装置自己流动
- **远期目标日定时**：定时栏可选日期，周五发布会这类远期目标一键布防
